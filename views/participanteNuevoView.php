...
<body>
	...
	<div class="container md-col-offset-2">
		<h2 class="text-center">Nuevo Participante para el Sorteo <?php echo $cod_sorteo; ?></h2>
		...
		<form action="index.php" method="post">
			...
			<input type="hidden" name="cod_sorteo" value="<?php echo $cod_sorteo; ?>">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" name="regalo">
			</div>

			<input class="btn btn-success btn-block" type="submit" name="submit" value="Aceptar">
			<button class="btn btn-danger btn-block" type="button" onclick="window.location.href='index.php?controlador=Participante&accion=listarByCodSorteo&cod_sorteo=<?php echo $cod_sorteo; ?>'">Cancelar</button>
		</form>
	</div>
	</br>
